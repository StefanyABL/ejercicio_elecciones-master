 ...
 private int votosTelevison;
  ...
  private int votosGeneroFemenino;
   ...
   private int votosGeneroMasculino;
     ...
     */
   private int votosRangoJovenes;
    
    /**
     * Número de votos de edad media (35 - 54).
     */
    private int votosRangoEdadMedia;
    
    /**
     * Número de votos de edad mayor (55 ó más).
     */
   private int votosRangoMayores;
    ...
    public void agregarVotoTelevision( )
    {
        ...
        //votos=votos+1;
    	votosTelevison=votosTelevison+1;
    }
    ...
    {
    	//TODO  Complete el método segú la documentación.
    	votosGeneroFemenino=votosGeneroFemenino+1;
    }
    ...
    {
    	votosGeneroMasculino=votosGeneroMasculino+1;
    	//TODO  Complete el método segú la documentación.
    }
    ...
    {
    	//TODO  Complete el método segú la documentación.
    	votosRangoJovenes=votosRangoJovenes+1;
    }
    ...
    {
    	//TODO  Complete el método segú la documentación.
    	votosRangoEdadMedia=votosRangoEdadMedia+1;
    }
    ...
    {
    	//TODO  Complete el método segú la documentación.
    	votosRangoMayores=votosRangoMayores+1;
    }
